...
const metaBase: Omit<Metadata, "alternates"> = {
  title: "Book a Demo",
  description:
    "See CloudAnzen in action. Book a personalized 30-minute demo with our team.",
};
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="pt-8">
            ...
            <p className="text-lg text-slate-500 mb-10">
              We&apos;ll show you exactly how CloudAnzen works for your
              team&apos;s specific use case — no generic product tour.
            </p>
