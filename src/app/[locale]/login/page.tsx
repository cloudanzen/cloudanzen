      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center gap-2.5 mb-6">
              <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-fuchsia-500 via-violet-500 to-emerald-500">
          ...
          <form action="#" method="POST" className="space-y-5">
            ...
            <div>
              <div className="flex justify-between mb-1.5">
                ...
                <a href="#" className="text-sm text-fuchsia-600 hover:underline">Forgot password?</a>
              </div>
        ...
        <p className="text-center text-sm text-slate-500 mt-6">
          ...
          <Link href="/demo" className="font-medium text-fuchsia-600 hover:underline">Book a demo</Link>
        </p>
      </div>
    </div>
  );
