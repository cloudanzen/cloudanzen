...
const metaBase: Omit<Metadata, "alternates"> = {
  title: "For Startups",
  description:
    "Get ISO 42001, SOC 2, or ISO 27001 done fast without hiring a compliance team. CloudAnzen is built for early-stage companies moving at startup speed.",
};
...
export async function generateMetadata({
  ...
  return {
    ...metaBase,
    alternates: localeAlternates(locale, "/solutions/startups"),
  };
}
...
export default function StartupsPage() {
  return (
    <SolutionPage
      ...
      useCases={[
        {
          title: "ISO 42001 for AI startups",
          desc: "Show buyers how you govern AI systems, model providers, data use, risk reviews, and human oversight.",
        },
        {
          title: "SOC 2 Type I in 4–6 weeks",
          desc: "Get your first report fast to unblock enterprise deals while you work toward Type II.",
        },
        {
          title: "ISO 27001 for EU expansion",
          desc: "Satisfy European buyer requirements with a structured ISMS implementation.",
        },
        {
          title: "Security posture baseline",
          desc: "Build your security program on a solid foundation that scales to Series B and beyond.",
        },
      ]}
      testimonial={{
        quote:
