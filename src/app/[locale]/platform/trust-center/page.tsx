...
export async function generateMetadata({
  ...
  return {
    ...metaBase,
    alternates: localeAlternates(locale, "/platform/trust-center"),
  };
}
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
            <div>
              <h2 className="heading-lg text-slate-900 mb-6">
                Stop re-explaining your security posture to every buyer
              </h2>
              <p className="text-slate-500 mb-8 leading-relaxed">
                With a CloudAnzen trust center, your compliance badges, policy
                documents, and security overviews are always available to the
                right people — gated by NDAs and access requests where needed.
              </p>
              ...
              <Link
                href="/demo"
                className="mt-8 inline-flex items-center gap-2 rounded-xl bg-slate-950 px-7 py-3.5 font-semibold text-white transition-colors hover:bg-slate-800"
              >
              ...
              <div className="bg-white p-6">
                ...
                <div className="space-y-3">
                  {[
                    ...
                    {
                      doc: "SOC 2 Type II Report",
                      icon: Lock,
                      access: "NDA Required",
                    },
                    {
                      doc: "Penetration Test Summary",
                      icon: Lock,
                    ...
                    <div
                      key={doc}
                      className="flex items-center justify-between py-2.5 px-4 rounded-lg bg-slate-50 border border-slate-100"
                    >
                      ...
                      <span
                        className={`text-xs px-2.5 py-1 rounded-full font-medium ${access === "Public" ? "bg-green-100 text-green-700" : access === "NDA Required" ? "bg-amber-100 text-amber-700" : "bg-fuchsia-100 text-fuchsia-700"}`}
                      >
                        {access}
                      </span>
                    </div>
