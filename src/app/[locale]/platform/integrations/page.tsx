...
const metaBase: Omit<Metadata, "alternates"> = {
  title: "Integrations",
  description:
    "Connect CloudAnzen to 100+ cloud, identity, HRIS, ticketing, and collaboration tools to collect evidence automatically.",
};
...
export async function generateMetadata({
  ...
  return {
    ...metaBase,
    alternates: localeAlternates(locale, "/platform/integrations"),
  };
}
...
const categories = [
  ...
  },
  {
    ...
    items: ["BambooHR", "HiBob", "Rippling", "Workday", "Gusto"],
  },
  {
    cat: "Ticketing",
    color: "bg-sky-50 border-sky-200",
    items: ["Jira", "Linear", "ServiceNow", "Asana", "GitHub Issues"],
  },
  {
    cat: "Collaboration",
    color: "bg-emerald-50 border-emerald-200",
    items: ["Slack", "Microsoft Teams", "Google Chat"],
  },
  {
    cat: "Endpoint & MDM",
    color: "bg-orange-50 border-orange-200",
    items: ["Jamf", "Kandji", "CrowdStrike", "SentinelOne"],
  },
  {
    cat: "Vulnerability & EDR",
    color: "bg-red-50 border-red-200",
    items: ["Snyk", "Tenable", "Qualys", "Wiz", "Lacework"],
  },
];
        ...
        <div className="page-shell">
          ...
          <div className="rounded-3xl border border-white/80 bg-[linear-gradient(135deg,#fdf4ff_0%,#fff7ed_50%,#ecfdf5_100%)] p-10 text-center shadow-[0_18px_40px_rgba(15,23,42,0.06)]">
            ...
            <p className="mb-8 text-slate-600">
              CloudAnzen supports custom integrations via API and webhooks. Talk
              to our team to discuss your stack.
            </p>
            <Link
              href="/contact"
