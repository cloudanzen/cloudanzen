...
export async function generateMetadata({
  ...
  return {
    ...metaBase,
    alternates: localeAlternates(locale, "/platform/vendor-risk"),
  };
}
...
const features = [
  {
    ...
    desc: "Maintain a complete, up-to-date inventory of all third-party vendors with risk tiers and business context.",
  },
  {
    icon: ClipboardCheck,
    title: "Standardized assessments",
    desc: "Send questionnaires, collect evidence, and track review status for every vendor in one workflow.",
  },
  {
    icon: RotateCcw,
    title: "Periodic review scheduling",
    desc: "Set review frequencies by risk tier. CloudAnzen reminds owners before reviews are due.",
  },
  {
    icon: ShieldAlert,
    title: "Inherent and residual risk scoring",
    desc: "Score vendors on inherent risk and residual risk after controls, aligned with your risk appetite.",
  },
];
        ...
        <div className="page-shell">
          ...
          <div className="rounded-3xl bg-violet-700 p-10 text-center">
            <h2 className="text-2xl font-bold text-white mb-4">
              Get your vendor program under control
            </h2>
            <p className="text-violet-200 mb-8 max-w-lg mx-auto">
              See how CloudAnzen helps procurement, security, and compliance
              teams work together on vendor risk.
            </p>
            <Link
              href="/demo"
              className="inline-flex items-center gap-2 px-7 py-3.5 rounded-xl bg-white text-violet-700 font-semibold hover:bg-violet-50 transition-colors"
            >
