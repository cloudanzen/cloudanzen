...
const metaBase: Omit<Metadata, "alternates"> = {
  ...
  description:
    "CloudAnzen was founded to make continuous GRC accessible to every team — not just those with large compliance budgets.",
};
      ...
      <section className="section-pad bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-slate prose-lg max-w-none mb-16">
            <p>
              CloudAnzen was founded on a simple belief: compliance should be a
              continuous, operational discipline — not a painful scramble before
              every audit.
            </p>
            <p>
              Most teams treat GRC as a project. They pull together evidence for
              three months, survive the audit, and repeat the cycle. Meanwhile,
              controls drift, risks accumulate, and no one quite knows the real
              state of their security posture.
            </p>
            <p>
              We built CloudAnzen to change that. By connecting to the systems
              your controls already depend on and continuously monitoring their
              health, we give security and compliance teams a real-time picture
              of where they stand — and the tools to fix gaps before they become
              findings.
            </p>
            <p>
              Our name reflects our mission: &ldquo;Cloud&rdquo; for modern
              infrastructure, and &ldquo;Anzen&rdquo; — the Japanese word for
              safety and security — for what we help you achieve.
            </p>
          </div>
          ...
          {/* Leadership */}
          <div className="mb-16">
            <p className="mb-3 text-center text-sm font-semibold uppercase tracking-widest text-fuchsia-600">
              Leadership
            </p>
            ...
            <p className="text-slate-500 text-center mb-12 max-w-2xl mx-auto">
              The vision and expertise driving CloudAnzen&apos;s mission to
              transform compliance into a continuous discipline.
            </p>
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              ...
              <div className="rounded-3xl bg-gradient-to-br from-fuchsia-500 via-violet-500 to-emerald-500 p-[1px]">
                <div className="h-full rounded-3xl bg-white p-8 sm:p-10 flex flex-col items-center text-center">
                  ...
                  <div className="mt-6 text-left text-slate-600 leading-relaxed space-y-4">
                    <p>
                      As the Founder of CloudAnzen, I developed a platform
                      designed to transform compliance into a continuous
                      operational discipline. The platform connects seamlessly
                      with existing systems, enabling real-time monitoring of
                      security and compliance to address organizational
                      challenges and foster ongoing efficiency.
                    </p>
                    <p>
                      My work emphasized collaboration and operational
                      improvement, aiming to eliminate the traditional audit
                      scramble and provide teams with a clear, consistent
                      understanding of their security posture.
                    </p>
                    <p>
                      With an MBA in Finance from JNTUH College of Engineering
                      Hyderabad, I bring expertise in problem solving, IT
                      business analysis, and business process analysis to every
                      initiative. My focus remains on innovating solutions that
                      promote operational resilience and enable organizations to
                      adapt effectively to a dynamic technological landscape.
                    </p>
                  </div>
              ...
              <div className="rounded-3xl bg-gradient-to-br from-fuchsia-500 via-violet-500 to-emerald-500 p-[1px]">
                <div className="h-full rounded-3xl bg-white p-8 sm:p-10 flex flex-col items-center text-center">
                  ...
                  <div className="mt-6 text-left text-slate-600 leading-relaxed space-y-4">
                    <p>
                      As Co-Founder and Chief Revenue Officer, I lead
                      CloudAnzen&apos;s go-to-market strategy — turning
                      continuous compliance from a technical advantage into a
                      business outcome our customers can measure.
                    </p>
                    <p>
                      My focus is building the sales, partnerships, and customer
                      success motions that get GRC programs live faster, so
                      security and revenue teams can move at the same speed.
                    </p>
                    <p>
                      I work closely with our product and engineering teams to
                      make sure what we sell matches what we ship — no gap
                      between the roadmap and the pitch.
                    </p>
                  </div>
          ...
          <div className="bg-slate-900 rounded-3xl p-10 text-center">
            <div className="mx-auto mb-6 flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-fuchsia-500 via-violet-500 to-emerald-500">
              <svg
            ...
            <p className="text-slate-400 mb-8">
              We&apos;re hiring engineers, GRC experts, and go-to-market talent
              who want to build the future of compliance automation.
            </p>
            <Link
