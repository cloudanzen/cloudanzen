        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-slate-900 rounded-3xl p-10 text-center">
            <div className="mx-auto mb-6 flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-fuchsia-500 via-violet-500 to-emerald-500">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="170 110 515 420" className="w-7 h-7 text-white">
            ...
            <Link href="/company/careers" className="inline-flex items-center gap-2 rounded-xl bg-slate-950 px-7 py-3.5 font-semibold text-white transition-colors hover:bg-slate-800">
