...
const metaBase: Omit<Metadata, "alternates"> = {
  title: "Partners",
  description:
    "Join the CloudAnzen partner program — auditors, consultants, MSSPs, and technology partners.",
};
...
export async function generateMetadata({
  ...
  return {
    ...metaBase,
    alternates: localeAlternates(locale, "/company/partners"),
  };
}
      ...
      <section className="section-pad bg-white">
        <div className="page-shell">
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            {[
              {
                type: "Audit & Consulting Partners",
                desc: "CPA firms and GRC consultants who use CloudAnzen to deliver compliance engagements for their clients.",
                perks: [
                  "Co-delivery on customer accounts",
              ...
              {
                type: "MSSP Partners",
                desc: "Managed security service providers who include CloudAnzen in their compliance-as-a-service offerings.",
                perks: [
                  "White-label options",
              ...
              },
              {
                ...
                desc: "SaaS vendors, cloud platforms, and security tools that integrate with CloudAnzen to extend our evidence network.",
                perks: [
          ...
          <div className="rounded-3xl border border-white/80 bg-[linear-gradient(135deg,#fdf4ff_0%,#fff7ed_50%,#ecfdf5_100%)] p-10 text-center shadow-[0_18px_40px_rgba(15,23,42,0.06)]">
            ...
            <p className="mb-8 text-slate-600">
              Tell us about your practice and we&apos;ll explore how to build
              something together.
            </p>
            <Link
              href="/contact"
